 ...
 */
function mixin <T extends Record<string, unknown>> (behaviour: T, sharedBehaviour = {}): <TClass extends { new (...args: any[]): {} }>(target: TClass) => TClass | void { // TODO: extend prototype
   ...
   */
  function _mixin <A extends { new (...args: any[]): {} }> (clazz: A): A {
    Object.getOwnPropertyNames(behaviour).forEach(property => {
      ...
      if (typeof propDescr.value === 'function') {
        ...
        clazz.prototype[property] = function (...args: any[]) {
          if (clazz.prototype[mixinKey].length === 1) { return clazz.prototype[mixinKey][0].apply(this, args) }

          for (const fn of clazz.prototype[mixinKey]) {
            if (fn.apply(this, args) !== undefined) { throw new Error('A mixed in method returned a value when undefined was expected.') }
          }
        }
      } else {
  ...
  Object.defineProperty(_mixin, Symbol.hasInstance, {
    value: (i: Record<string, any>) => !!i[typeTag as any]
  })
  return _mixin
}
